...
```bash
git clone https://github.com/username-anda/quiz-app-frontend.git
...
- **Mengubah alamat remote repository (jika sudah ada):**
  ```bash
  git remote set-url origin https://github.com/username-baru/quiz-app-frontend.git
  ```
- **Menambahkan remote repository baru (jika belum ada `origin`):**
  ```bash
  git remote add origin https://github.com/username-baru/quiz-app-frontend.git
  ```
